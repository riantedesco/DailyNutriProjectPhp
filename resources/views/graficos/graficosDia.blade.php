...
@section('content')
    ...
    <div class="card m-b-20">
        <div class="card-body">
            <h3 class="mt-0 header-title mb-3" style="text-transform: uppercase; text-align: center">Média nutricional de hoje
            </h3>
            <p style="font-size: 18px; text-align: center">
                <i>{{ Carbon\Carbon::parse($dataHoje)->format('d/m/Y') }}</i>
            </p>
            <hr>

            @if ($refeicoesDiarias->isEmpty())
                <br>
                <div>
                    <h4 style="font-family: system-ui; text-align: center">Nenhuma refeição cadastrada no dia de hoje.</h4>
                </div>
                <br>
            @else
                <div class="inbox-wid">
